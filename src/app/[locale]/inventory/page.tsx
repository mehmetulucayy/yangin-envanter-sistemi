    ...
    <div className="max-w-6xl mx-auto px-6 py-10">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          <input name="tupadi" placeholder={t("fields.tupadi")} value={form.tupadi} onChange={handleChange} className="p-3 rounded-lg bg-[#2A303C] text-white w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
          ...
          <input name="uretimYili" placeholder={t("fields.uretimYili")} value={form.uretimYili} onChange={handleChange} className="p-3 rounded-lg bg-[#2A303C] text-white w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
        ...
        {envanterListesi.length === 0 ? (
          ...
          <ul className="space-y-3">
            {envanterListesi.map((item) => (
              <li key={item.id} className="bg-[#2A303C] p-4 rounded-lg flex justify-between items-center hover:bg-[#323846] transition">
                <div>
